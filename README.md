...
- Next.js (для SSR, SEO и удобной работы с TMA)  
- TypeScript (строгая типизация)  
- Tailwind CSS (быстрый адаптивный дизайн)  
- Framer Motion (анимации интерфейса)  
- WebSockets (для live-обновлений статуса заказов)  
- Telegram WebApp SDK (интеграция с TMA)
...
1. Настроить Next.js с TypeScript и Tailwind  
2. Создать базовый адаптивный лейаут с параллакс-эффектами (Framer Motion)  
3. Интегрировать Telegram WebApp SDK с проверкой платформы (TMA/Web)  
4. Реализовать динамическое кофейное меню с 3D-превью товаров (CSS transform)  
5. Подключить WebSocket для live-статусов заказов  
6. Добавить TMA-специфичные фичи: платежи, контакт-лист  
7. Оптимизировать загрузку (ленивая загрузка видео, прелоадер)
